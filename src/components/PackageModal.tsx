  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl w-full max-w-5xl max-h-[90vh] flex flex-col md:flex-row relative shadow-xl">
        ...
        <div className="w-full md:w-1/2 flex flex-col md:max-h-[90vh]">
          {/* Scrollable content */}
          <div className="flex-1 overflow-y-auto px-4 py-5 md:p-8 pb-24">
          ...
          <div className="border-t bg-white md:mt-auto">
            <div className="p-4">
              <button

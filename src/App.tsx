...
import { MapPin, Users, Building2, Calendar, ArrowRight, Search, Filter, Star, LogOut, Clock, IndianRupee, Menu, X, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 sm:py-6 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          <Link to="/" className="flex items-center space-x-2">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-white lowercase">tripuva</h1>
          </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 py-0 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="text-sm text-gray-500">
            Showing {indexOfFirstPackage + 1}-{Math.min(indexOfLastPackage, filteredPackages.length)} of {filteredPackages.length} trips
          </div>
        </div>
